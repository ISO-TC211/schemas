...
https://schemas.isotc211.org/19115/-1/mpc/1.3.0/portrayalCatalogue.xsd[https://schemas.isotc211.org/19115/-1/mpc/1.3.0/portrayalCatalogue.xsd] contains the following class:
