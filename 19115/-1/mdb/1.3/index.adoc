...
https://schemas.isotc211.org/19115/-1/mdb/1.3.0/metadataBase.xsd[https://schemas.isotc211.org/19115/-1/mdb/1.3.0/metadataBase.xsd] contains the following classes:
