...
https://schemas.isotc211.org/19115/-1/mco/1.3.0/constraints.xsd[https://schemas.isotc211.org/19115/-1/mco/1.3.0/constraints.xsd] contains references to the following codelists:
