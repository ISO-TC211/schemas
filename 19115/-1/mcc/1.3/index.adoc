...
https://schemas.isotc211.org/19115/-1/mcc/1.3.0/AbstractCommonClasses.xsd[https://schemas.isotc211.org/19115/-1/mcc/1.3.0/AbstractCommonClasses.xsd] contains the following
classes:
